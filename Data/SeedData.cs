    ...
    public class SeedData
    {
            ...
            string password="Manager@demo1")
        {
                ...
                serviceProvider.GetRequiredService<DbContextOptions<ApplicationDbContext>>()))
            {
                ...
                await EnsureRole(serviceProvider, managerUid, Constants.ApplicationManagerRole);

                // administrator
                var adminUid = await EnsureUser(serviceProvider, "admin@demo.com", password);
                await EnsureRole(serviceProvider, adminUid, Constants.ApplicationSuperAdminRole);
            }
        }
